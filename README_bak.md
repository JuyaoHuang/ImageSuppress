...
- 文章：
  `target_content\WebFullStack\Fronted\BaseKnows\FrontedLanguages.md`
- 图片目录：
  `target_content\WebFullStack\Fronted\BaseKnows\img_for_前端三件套`
